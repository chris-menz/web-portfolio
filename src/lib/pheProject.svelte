...
<style>
    *, *::before, *::after {
    ...
    .buttons-container a, .buttons-container a:visited {
        font-size: 1.25rem;
    ...
    .purpose-tab:hover, .features-tab:hover {
        color: rgb(0, 0, 0);
        transition-duration: 300ms;
    }
    ...
    .features-list li {
        margin-bottom: 00.3875em;
        font-size: 1.3125rem;
    }

    .features-list ul {
        margin-top: -0.25em;
        margin-bottom: 00.3125em;
        margin-left: 1.5em;
        list-style: none;
    }
